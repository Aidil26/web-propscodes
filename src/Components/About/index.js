      ...
      <div className="container flex">
        <div className="row about-content" style={{ justifyContent: 'center', alignContent: 'center', height: heihgt }}>
          <div className="col-md-12">
            <h3 id="about" style={{ textAlign: 'center', fontFamily: 'Open Sans' }}>About Us</h3>
            <div className="col-md-10 offset-md-1">
              <p style={{ textAlign: 'center', fontSize: 16, lineHeight: 2, fontFamily: 'Open Sans' }}>
              It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like . kami menawarkan suatu layanan dimana client akan mendapatkan beberapa keuntugan diantaranya
